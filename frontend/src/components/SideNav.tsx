    ...
    <div className="w-20 bg-black/20 backdrop-blur-md border-r border-white/10 flex flex-col items-center py-6">
      <div
        className={`relative mb-8 cursor-pointer ${
          isProfile
            ? 'ring-2 ring-purple-400/70 rounded-full ring-offset-2 ring-offset-black/20'
            : ''
        }`}
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        >
          <ChatBubbleOutlineIcon
            style={{ fontSize: 20 }}
            className={isChats ? 'text-white' : 'text-teal-200'}
          />
        </div>
        ...
        <div
          className={`w-10 h-10 rounded-full flex items-center justify-center cursor-pointer transition-all ${
            isSettings
              ? 'bg-purple-500/30 border border-purple-300/60 shadow-md'
