    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4">
        <div className="relative">
          ...
          />
          <svg
            className="absolute right-3 top-3.5 w-5 h-5 text-teal-200/50"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        {!friendList || friendList.length === 0 ? (
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="text-center">
              ...
              <p className="text-teal-200/70 text-lg font-medium">
            ...
            {filterdItems.map((friend) => {
              ...
              return (
                ...
                >
                  {/* Avatar */}
                  <div
                    className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg mr-4 ${getAvatarColors(
                      friend.username,
                      isSelected
                    )}`}
                  >
